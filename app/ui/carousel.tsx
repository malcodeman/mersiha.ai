  ...
  return (
    ...
    >
      <ArkCarousel.Viewport className="relative h-full overflow-x-hidden rounded-[20px]">
        ...
        <ArkCarousel.Control className="absolute bottom-4 left-1/2 flex -translate-x-2/4 items-center gap-4 rounded border border-[#272727] bg-[#161616CC] p-1">
          <ArkCarousel.PrevTrigger className="disabled:opacity-50">
            <LuChevronLeft />
          </ArkCarousel.PrevTrigger>
          <ArkCarousel.IndicatorGroup className="flex gap-4">
            {items.map((item, i) => (
